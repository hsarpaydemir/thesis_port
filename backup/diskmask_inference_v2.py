...
test_opts = {'has_smpl_dstrb': 1, 'has_flip': 1, 'deform_magnitude': 0, 
            ...
            'padding': 'zeros', 'average_mirror': False, 'path2save': '/home/haydemir/Desktop/connectivity/thesis/pythorch_port/inference_results',
            'saveHDF5': True}
...
for im_i in range(numb_data):
    ...
    #save results
    path2saveres = '/home/haydemir/Desktop/connectivity/thesis/pythorch_port/inference_results'
    if test_opts['saveHDF5'] == True:
        path2hdf5 = path2saveres + '/' + fileName_s + '_imNr_' + str(im_i + 1) + '_' + str(numb_data) + '_predMasks.h5'
