...
class DiskMaskNet(nn.Module):
    def __init__(self):
        ...
        self.n1_d1c = nn.Sequential( #(1, 3, 512, 512)
        ...
        self.n1_d2c = nn.Sequential( #(1, 64, 256, 256)
        ...
        self.n1_d3c = nn.Sequential( #(1, 128, 128, 128)
            nn.MaxPool2d(kernel_size=(2, 2), stride=(2, 2)),
        ...
        self.n1_d4c = nn.Sequential( #(1, 256, 64, 64)
            nn.MaxPool2d(kernel_size=(2, 2), stride=(2, 2)),
        ...
        self.n1_u3d = nn.Sequential( #(1, 512, 32, 32)
        ...
        self.n1_u2d = nn.Sequential( #(1, 256, 64, 64)
        ...
        self.n1_u1d = nn.Sequential( #(1, 256, 128, 128)
            nn.ConvTranspose2d(in_channels=256, out_channels=256, kernel_size=(2, 2), stride=2, padding=0),
            nn.ReLU(),
            nn.Conv2d(in_channels=256, out_channels=256, kernel_size=(3, 3), padding=1),
            nn.ReLU(),
        ...
        self.predict_instance_masks = nn.Sequential( #(1, 256, 256, 256)
    ...
    def forward(self, x):
        ...
        #n1_u1d = self.first_part(n1_d4c) #(1, 256, 164, 164)
...
def main():
    ...
    X = torch.rand((10, 3, 512, 512), device=device)
