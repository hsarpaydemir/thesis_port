...
def main():
    ...
    enco_criterion = nn.CrossEntropyLoss(ignore_index=255) #Same with caffe SoftmaxWithLoss layer (Softmax followed by multinomial logistic loss)
